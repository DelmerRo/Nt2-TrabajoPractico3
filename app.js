    ...
    methods: {
        ...
        atacar: function () {
            ...
            this.registrarEvento({
                esJugador: true,
                text: 'El jugador golpea al mountruo por ' + damage
            });
        ...
        ataqueEspecial: function () {
            ...
            this.registrarEvento({
                esJugador: true,
                text: 'El jugador golpea con ataque especial por  ' + damage
            });
            if (this.verificarGanador()) {
                return;
            }
        ...
        curar: function () {
            ...
            if (this.saludJugador <= 90) {
                ...
                this.registrarEvento({
                    esJugador: true,
                    text: 'Te curaste en un ' + CURA
                });
            } else {
                this.registrarEvento({
                    esJugador: true,
                    text: 'aUN NO NECESITAS CURARTE '
                });
                this.saludJugador = 100;
            }
            this.ataqueDelMonstruo();
